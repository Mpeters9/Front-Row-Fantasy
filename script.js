document.addEventListener('DOMContentLoaded', () => {
    ...
    const App = {
        ...
        async getAITradeAnalysis() {
            ...
            const prompt = `Act as a fantasy football expert. Analyze this ${this.tradeState.tradeType} league trade...`;
        ...
        async getAiDraftGrade() {
            ...
            const prompt = `Act as an expert fantasy football analyst. I have just completed a mock draft...`;
